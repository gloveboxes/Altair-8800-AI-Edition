 ...
 * @brief Shared input ring buffer for the emulated Altair terminal.
 *
...
/**
 * @brief Initialize the shared terminal input ring buffer.
 *
 ...
 *
 * Non-blocking. If the buffer is full, the oldest byte is discarded and the
