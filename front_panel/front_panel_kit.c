...
#define KIT_PIN_SWITCH_LOAD ALTAIR_FRONT_PANEL_KIT_SWITCH_LOAD_GPIO
#define KIT_PIN_SWITCH_CS ALTAIR_FRONT_PANEL_KIT_SWITCH_CS_GPIO
#define KIT_PIN_MISO ALTAIR_FRONT_PANEL_KIT_MISO_GPIO
#define KIT_PIN_MOSI ALTAIR_FRONT_PANEL_KIT_MOSI_GPIO
#define KIT_PIN_RESET ALTAIR_FRONT_PANEL_KIT_RESET_GPIO
#define KIT_PIN_CLK ALTAIR_FRONT_PANEL_KIT_CLK_GPIO
#define KIT_PIN_LED_STORE ALTAIR_FRONT_PANEL_KIT_LED_STORE_GPIO
#define KIT_PIN_LED_OE ALTAIR_FRONT_PANEL_KIT_LED_OE_GPIO

#define KIT_SPI_HOST ALTAIR_FRONT_PANEL_KIT_SPI_HOST
...
bool front_panel_kit_init(void)
{
    ...
    ESP_LOGI(TAG, "%s front panel kit ready: SPI%d %d Hz mode 2, LOAD=%d CS=%d MISO=%d MOSI=%d RESET=%d CLK=%d STORE=%d OE=%d",
             ALTAIR_BOARD_NAME, KIT_SPI_HOST + 1, KIT_SPI_CLOCK_HZ,
